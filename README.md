...
1. **image-override** (optional) :
   The ECR image URI of the environment that CodeBuild requires.
   By default, the action uses the default environment that
   you configured in the CodeBuild project.
